...
<script>
    function openEditModal(id) {
        ...
        if (skill) {
            document.getElementById('edit-form').action = '<?php echo e(url('skills')); ?>/' + id;
...
<?php /**PATH D:\xampp\htdocs\profile_builder\resources\views/partials/update-skill-modal.blade.php ENDPATH**/ ?>