    ...
    <div class="max-w-6xl mx-auto py-8">
        ...
        <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-lg text-white p-6 shadow-xl mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <button onclick="window.location='{{ route('admin.profile.edit') }}'"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        @if ($adminProfile?->is_suspended)
                            <div class="mt-3 p-3 bg-red-50 border border-red-200 rounded w-full text-center">
                                ...
                                @if ($adminProfile->suspension_lifts_at)
                                    <p class="text-xs text-red-600 mt-1">Lifts on:
                                        {{ $adminProfile->suspension_lifts_at->format('M d, Y') }}</p>
                                @endif
                            </div>
                        @endif
                        ...
                        <div class="mt-4 text-sm text-gray-600 text-center">
                            ...
                            <div class="mt-1">{{ $adminProfile?->office_location ?? 'Office not set' }}</div>
                        </div>
                                ...
                                <div class="p-2 bg-purple-50 rounded">
                                    <div class="font-semibold text-purple-600">
                                        @if ($adminProfile?->last_login)
                                            {{ $adminProfile->last_login->diffForHumans() }}
                                        @else
                                            Never
                                        @endif
                                    </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="text-xs text-gray-500">Member since {{ $user->created_at->format('M d, Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                ...
                <!-- Activity Section -->
                @if ($adminProfile?->last_activity || $adminProfile?->last_login)
