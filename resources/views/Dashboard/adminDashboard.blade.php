                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($recent_users as $user)
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">{{ ucfirst($user->role) }}
                                </td>
        ...
        <script>
            (function() {
                ...
                if (ctx1) {
                    ...
                    const data = {!! json_encode($user_registrations) !!};
